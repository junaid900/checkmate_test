...
import '../../../providers/post/post_comment_provider.dart';
import '../../../providers/user/profile_provider.dart';

class CommentItem extends StatefulWidget {
  final PostComment commentItem;
  final Function(PostComment) onReplyClick;
  bool isReply = false;
              ...
              ? Column(
                  children: [
                    if ( widget.commentItem.viewReplies)
                      InkWell(
                        onTap: () async {
                          var postCommentProvider = context.read<PostCommentProvider>();
...
void _commentActionSheet(BuildContext context, PostComment comment) {
      ...
      actions: <CupertinoActionSheetAction>[
                ...
                return AlertDialog(
                  ...
                  actions: [
                    ...
                    TextButton(
                      child: Text('Update'),
                      onPressed: () async {
                        var postCommentProvider =
                            context.read<PostCommentProvider>();
                        // var storyProvider = context.read<PostProvide>();
                        showProgressDialog(context, "Updating....");
                        var res = await postCommentProvider.editComment(
                            comment.id, commentController.text);
        ...
        CupertinoActionSheetAction(
          onPressed: () async {
            ...
            var res = await postCommentProvider.deleteComment(comment);
            hideProgressDialog(context);
            if (res == 1) {
